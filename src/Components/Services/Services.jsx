...
import Resume from './MiltonResume.pdf'
        ...
        <div className="cards">
            <motion.div
             ...
             transition={transition}>
              <Card
                emoji = {HeartEmoji}
                heading = {'Design'}
                detail = {'UI/UX, HTML, CSS, Javascript, React, Tailwind CSS, Photoshop and Poster'}
              />
            </motion.div>
            ...
            transition={transition}>
              <Card
                emoji = {Glasses}
                heading = {'Developer'}
                detail = {'Java, JDBC, Servlet, NodeJs, ReactJs and NextJs, SQL'}
              />
            </motion.div>
